...
import {APICallUrl, Choose, Emailaddress} from "../../Constant";
import {
    setCheckoutDetails,
    setCheckoutErrors,
    setShippingErrors,
...
const ShippingForm = ({
                          ...
                          setStateMismatch,
                          zipMismatch,
                          setZipMismatch, isLoaded, loadError,
                      }) => {
    ...
    useEffect(() => {
        ...
        dispatch(setShippingErrors(Object.keys(formik.errors).length));
    }, [formik])
                ...
                <Row className='g-4'>
                    ...
                    <Col md='4'>
                        ...
                        <input type='text' className='form-control checkout-form' id='address2'
                               ...
                               onChange={formik.handleChange}
                               onBlur={formik.handleBlur} autoComplete="nope"
                        />
