...
import {
    ...
    getMainMenu, getNewArrival, getNewOffer, getSpecialOffer,getSlider, getShopByCategory, selectBrands,
    selectFooterCenter,
    selectFooterLeft,
    selectFooterRight,
    ...
    return (
        <>
            ...
            <Layout6 mainMenu={data?.mainMenu[0]} footerLeft={data?.footerLeft} footerCenter={data?.footerCenter}
                ...
                {
                    !auth ? <MyProjectsSection/> :
                        <Container>
                            <Row style={{padding: "20px 0", justifyContent: "center"}}>
                                <Col lg="4">
                                    <BeforeSignInAccount signIn={signIn} isOpen={isOpen} setIsCartOpen={setIsCartOpen}/>
                                </Col>
