...
export async function getServerSideProps({res, params}) {
    ...
    try {
        const categoriesDataResponse = await fetch(`${APICallUrl}/shop/${params?.category}?per_page=12&json=true`);
...
const Category = ({data}) => {
    ...
    // let urlID = useSelector(selectUrl);
    ...
    useEffect(() => {
        const handleStart = (url) => {
            ...
            //     setIsLoading(true);
            // }
            if (`/shop/${router?.query?.id}/${router?.query?.category}/` !== basePath) {
                setIsLoading(true);
                dispatch(setFirst(false));
                        ...
                        <>
                            {
                                ...
                                <>
                                    ...
                                    <ShopLeftSidebarContain
                                        ...
                                        shopCategory={shopCategory?.category}
                                        listGrid={listGrid} sale=""
                                    />
                                </>
