...
export async function getServerSideProps() {
    const brandsData = await fetch(`${APICallUrl}/item?json=true&per_page=12&new_products=true`);
...
const WhatsNew = ({data}) => {
    ...
    //         fetch(`${APICallUrl}/item?json=true&per_page=12&new_products=true`, {
    //             method: 'GET',
    //             headers: {
                     ...
                     footerRight={data?.footerRight}>
                {
                    ...
                    <>
                        ...
                        <ShopLeftSidebarContain
                            ...
                            shopFilters={shopCategory?.filters} sale="&new_products=true"
