        ...
        <svg xmlns='http://www.w3.org/2000/svg' id='store' viewBox='130 0 1230 930'>
            <defs>
                ...
                <g id='tree'>
                    ...
                    <path fill='none' className='stroke round-end'
                          d='M1085.2 552.4c-29.4 14.7-49.5 45-49.5 80.1 0 49.4 40.1 89.5 89.5 89.5 49.4 0 89.5-40.1 89.5-89.5 0-35.2-20.3-65.6-49.8-80.2'/>
                    <path fill='none' className='stroke round-end'
                          d='M1164.9 552.3c10-10.1 16.1-24 16.1-39.3 0-30.9-25.1-56-56-56s-56 25.1-56 56c0 15.4 6.2 29.3 16.2 39.4'/>
                ...
                <g id='cat'>
                    ...
                    <path fill='#FFF' stroke='#f4a9bc' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round'
                          strokeMiterlimit='10' d='M1097.1 612.3c0 0-4.5-9.3-0.3-17.7 0 0 4.5 5.6 9.3 7'/>
                    <path fill='#FFF' stroke='#f4a9bc' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round'
                          strokeMiterlimit='10' d='M1140.6 612.3c0 0 4.5-9.3 0.3-17.7 0 0-4.5 5.6-9.3 7'/>
                    <circle fill='#FFF' stroke='#f4a9bc' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round'
                            strokeMiterlimit='10' cx='1118.6' cy='621.7' r='23.1'/>
                    ...
                    />
                    <path fill='#FFF' stroke='#f4a9bc' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round'
                          strokeMiterlimit='10' d='M1104.7 613c0 0 0-3.1 2.8-3.8 2.9-0.8 4.2 1.7 4.2 1.7'/>
                    <path fill='#FFF' stroke='#f4a9bc' strokeWidth='3' strokeLinecap='round' strokeLinejoin='round'
                          strokeMiterlimit='10' d='M1132.6 613c0 0 0-3.1-2.8-3.8 -2.9-0.8-4.2 1.7-4.2 1.7'/>
                    <path fill='#f4a9bc'
                ...
                <g id='parachute'>
                    ...
                    <path fill='none' className='stroke'
                          d='M429.4 2.5c-36.7 0-66.3 32.4-66.3 72.4 -9.3-6.7-19.4-5.9-30.1 0C333 74.9 355 2.5 429.4 2.5'/>
                    <path fill='none' className='stroke'
                          d='M429.6 2.5c36.7 0 66.3 32.4 66.3 72.4 9.3-6.7 19.4-5.9 30.1 0C526 74.9 504 2.5 429.6 2.5'/>
                    <path fill='none' className='stroke'
                ...
                <g id='box'>
                    ...
                    <polygon fill='none' className='stroke'
                             points=' 394.1 47 394.5 81.5 408.5 70.5 422.5 81.5 422.5 47 463.3 31 431.7 31 '/>
                </g>
                <path
                    id='tshirt'
                ...
                />
                <g id='cap'>
                    <path fill='#FFF' className='stroke'
                ...
                <g id='plane'>
                    ...
                    <text transform='matrix(1.0027 0 0 1 44.8218 224.8768)' fontFamily='Fredoka One' fontSize='34'
                          fill=''>
                        {' '}
            ...
            <g id='toldo'>
                <polyline fill='#FFF' className='stroke round-end'
                ...
                <path id='tol' fill='#FFF' className='stroke'
            ...
            <g id='door'>
                ...
                <g id='sign'>
                    ...
                    <text transform='matrix(1.0027 0 0 1 789.6294 721.7501)' fill='#FFF' fontFamily='Fredoka One'
                          fontSize='38'>
                        OPEN
                    </text>
                    <path fill='none' className='stroke'
